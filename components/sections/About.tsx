...
//             <motion.a
//               href="/Peter Toss-CV-Full-Stack Developer.pdf"
//               download
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <motion.div
          className="absolute top-1/3 left-1/4 w-72 h-72 bg-indigo-500/10 rounded-full blur-3xl"
      ...
      <div className="container">
        ...
        >
          ...
          <div className="mx-auto w-20 h-1 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full" />
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          >
            <div className="grid grid-cols-2 gap-8 text-center">
              {[
                { value: '10+', label: 'Projects', color: 'text-indigo-400' },
                { value: '5+', label: 'Clients', color: 'text-cyan-400' },
                { value: '99%', label: 'Satisfaction', color: 'text-purple-400' },
